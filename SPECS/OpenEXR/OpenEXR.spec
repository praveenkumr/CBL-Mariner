...
# Fix bogus table generation leading to -Wnarrowing failures on some targets
...
%changelog
* Mon Jan 25 2021 Fedora Release Engineering <releng@fedoraproject.org> - 2.3.0-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Fri Dec 10 2020 Jeff Law <law@redhat.com> - 2.3.0-7
- Fix incorrect printf format specifier which caused bogus tables to
  be generated, which in turn was flagged with narrowing conversions
  by gcc-11
